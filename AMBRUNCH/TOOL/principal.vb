...
Module principal
    ...
    End Function
    'Public Function BackUp(ByVal Path As String) As Boolean
    '    Try
    '        Process.Start(My.Settings.dump, "-v --opt --events --routines --triggers --default-character-set=utf8 --user=" & My.Settings.user & " --password=" & My.Settings.pwd & " --host=" & My.Settings.server & " --databases " & My.Settings.db & " -r " & """" & Path & """")
    '        Return True
...
#Enable Warning BC42104 ' Se usa la variable antes de que se le haya asignado un valor
    ...
    Public Sub ExportarDatosExcel(ByVal DataGridView1 As DataGridView, ByVal titulo As String)
        ...
        With objHojaExcel
            ...
            'Encabezado  
            .Range("A1:L1").Merge()
            .Range("A1:L1").Value = "SISTEMA AM BRUNCH"
    ...
    Public Sub ExportarEXCEL(ByVal DataGridView1 As DataGridView, ByVal titulo As String)
        Dim archivo As String
        Dim origen As String
        Dim folder As String = Application.StartupPath & "/reportes"


        If Not Directory.Exists(Application.StartupPath & "\reportes") Then
            Directory.CreateDirectory(Application.StartupPath & "\reportes")
        End If
        origen = Application.StartupPath & "/files/RPTPROD.xlsx"
        archivo = Application.StartupPath & "/reportes/REPORTE DE PRODUCTOS " & DateTime.Now.ToString("yyyyMMddHHmmss") & ".xlsx"


        If copiararchivo(origen, archivo) = True Then




            Dim m_Excel As New Excel.Application
            m_Excel.Workbooks.Open(archivo)
            'm_Excel.Cursor = Excel.XlMousePointer.xlWait
            'm_Excel.Visible = True
            ...
            Dim objHojaExcel As Excel.Worksheet = m_Excel.Worksheets(1)
            ...
            With objHojaExcel
                ...
                '.Range(primeraLetra + "2", UltimaLetraIzq + UltimaLetra + "2").Font.Size = 12
                .Range(primeraLetra + "1", UltimaLetraIzq + UltimaLetra + "1").Font.Bold = True
                .Range(primeraLetra + "1", UltimaLetraIzq + UltimaLetra + "1").HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter
                Dim objRango As Excel.Range = .Range(primeraLetra + primerNumero.ToString, UltimaLetraIzq + UltimaLetra + (UltimoNumero - 1).ToString)
